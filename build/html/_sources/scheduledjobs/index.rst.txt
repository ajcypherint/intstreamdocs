...
Scheduled jobs are run on a cron schedule 

Develop Scheduled Job
=====================
...
4. run :bash:`python job.py` to test your job
5. create a :bash:`requirements.txt` file in the same directory as :bash:`job.py`
6. :bash:`tar -czf job.tar.gz requirments.txt job.py`
   
Install / Cron Schedule
=======================

1. Go to Sources | Scheduled jobs. 
2. Create Job and set cron. 
3. Add version. 
4. Name and upload `job.tar.gz`
